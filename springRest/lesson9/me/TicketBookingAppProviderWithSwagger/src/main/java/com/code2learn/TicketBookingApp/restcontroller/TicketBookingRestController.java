...
import com.code2learn.TicketBookingApp.model.Ticket;
import com.code2learn.TicketBookingApp.service.ITicketBookingService;
...
@Tag(name="TicketBookingAPIS", description="APIS to book ticket and get ticket detail")
public class TicketBookingRestController 
{
    ...
    @Operation(summary="POST request ",description="API will accept json passenger info and will return ticket number wit ticket object")
    public ResponseEntity<Ticket> registerPassenger(@RequestBody Passenger passenger)
    {
        ...
        ticket.setTicketNumber(p.getPid());
        return new ResponseEntity<Ticket>(ticket,HttpStatus.OK);
    }

    @GetMapping("/getTicket/{ticketNumber}")
    @Operation(summary="GET request ",description="API will accept ticket number and will return ticket number with ticket object")
